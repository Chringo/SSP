	...
	if (inputHandler->IsKeyDown(SDL_SCANCODE_W))
	{
		...
		if (this->m_aComp->lockAnimation != true)
		{
			...
			if (m_grabbed != nullptr)
			{
				...
				{
					SetAnimationComponent(PLAYER_RUN_FORWARD_BALL, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
			...
			else
			{
				...
				{
					SetAnimationComponent(PLAYER_RUN_FORWARD, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
	...
	if (inputHandler->IsKeyDown(SDL_SCANCODE_S))
	{
		...
		if (this->m_aComp->lockAnimation != true)
		{
			if (m_grabbed != nullptr)
			{
				...
				{
					SetAnimationComponent(PLAYER_RUN_BACKWARD_BALL, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
			...
			else
			{
				...
				{
					SetAnimationComponent(PLAYER_RUN_BACKWARD, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
		...
		if (this->m_aComp->lockAnimation != true)
		{
				...
				!inputHandler->IsKeyDown(SDL_SCANCODE_S) && inputHandler->IsKeyDown(SDL_SCANCODE_D))
			{
				if (m_grabbed != nullptr)
				{
					...
					{
						SetAnimationComponent(PLAYER_RUN_RIGHT_BALL, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
				...
				else
				{
					...
					{
						SetAnimationComponent(PLAYER_RUN_RIGHT, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
			...
			!inputHandler->IsKeyDown(SDL_SCANCODE_S) && inputHandler->IsKeyDown(SDL_SCANCODE_A))
		{
			if (this->m_aComp->lockAnimation != true)
			{
				if (m_grabbed != nullptr)
				{
					...
					{
						SetAnimationComponent(PLAYER_RUN_LEFT_BALL, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
				...
				else
				{
					...
					{
						SetAnimationComponent(PLAYER_RUN_LEFT, 0.40f, Blending::SMOOTH_TRANSITION, true, false, 2.0f);
