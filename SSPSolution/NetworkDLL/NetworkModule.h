...
public:
	...
	NETWORKDLL_API void SendAnimationPacket(unsigned int entityID, int newState, float transitionDuritation, int blendType, bool isLooping, bool lockAnimation, float playingSpeed, float velocity,int jointIndex, DirectX::XMMATRIX finalJointTransform);
